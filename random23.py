# MAKE BY NAI AMI
# Telegram Id : BOLA JABE NA
# Telegram : BOLA JABE NA
# Facebook Group : BOLA JABE NA
...
def Alhaj():
    os.system('clear')
    os.system('xdg-open https://m.facebook.com/groups/5224774950949160/')
    print(logo)
    print("")
    print("\033[1;96m ╔═════════════════════════════════╗")
